...
Please check the [DataImport User Guide.pdf](DataImport User Guide.pdf) if you need help configuring Data Import using an existing template to load data into the Ed-Fi ODS.
